...
public class Login 
{
	...
	{
		System.setProperty("webdriver.chrome.driver","C:\\Audit\\AuditProject\\Chrome\\chromedriver.exe");
	...
	{		
		...
		if(method.equalsIgnoreCase("License"))
			...
			{
				locators.clickARS(driver).click();			//Clicking on Litigation Image.
			}
			else
			{
